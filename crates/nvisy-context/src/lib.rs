...
//!
//! A [`Context`] holds reusable reference data (names, faces,
//! voices, patterns, embeddings) that tells detection *what to
//! look for*. It is separate from policy (which controls *what
//! to do* when something is found).
