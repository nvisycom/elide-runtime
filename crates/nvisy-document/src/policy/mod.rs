...
pub use nvisy_toolkit::redaction::{
    AudioMethodTag, AudioStrategy, ImageMethodTag, ImageStrategy, Redactable, TabularStrategy,
    TextStrategy,
};
...
pub struct Policy<M: Redactable> {
