...
//! [`Handler::next_chunk`]: nvisy_codec::core::Handler::next_chunk
...
async fn populate_text_blocks(
    ...
    handle: &mut dyn nvisy_codec::core::Handler<Text>,
) -> Result<()> {
...
async fn populate_tabular_blocks(
    ...
    handle: &mut dyn nvisy_codec::core::Handler<Tabular>,
) -> Result<()> {
...
async fn populate_audio_doc(
    ...
    handle: &mut dyn nvisy_codec::core::Handler<Audio>,
...
async fn populate_audio_doc(
    ...
    _handle: &mut dyn nvisy_codec::core::Handler<Audio>,
    _descriptor: &ContentDescriptor,
    _plan: &Extraction,
) -> Result<()> {
    Ok(())
