...
///
/// Loaded from TOML with built-in defaults. Consumers (typically
/// the CLI) apply their own override layer on top before handing
/// the resolved value to [`crate::ServiceRuntime`].
