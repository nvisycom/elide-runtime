...
/// [`Handler::lift_chunk`] and reshaped into `Entity<M>` via
/// [`LiftedFromText`].
///
/// Callers `use nvisy_toolkit::detection::RecognizerRegistryExt;`
